...
**Response**: Sometimes I find the error messsages unhelpful as they may say something one thing is wrong but it's another (especially with simple mistakes)? It's more useful to help find where an error is.
...
**Response**: use the ? thingy. c/rbind combine via column or row while c creates one large vector 
...
**Response**: we googled how to change something into a data frame. and then remembered that the name of what we are assigning to comes first.
...
**Response**: we had to use a different function as length ain't cutting it
